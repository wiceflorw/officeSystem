                    ...
                    <div class="subfiled-content">
                        <div class="sapar-form">
                            ...
                            <div class="kv-item clearfix">
                                <label>出发日期：</label>
                                <div class="kv-item-content">
                                    <input type="text" placeholder="选择出发日期"
                                           onfocus="WdatePicker({doubleCalendar:true,dateFmt:'yyyy-MM-dd',minDate:'%y-%M-{%d}'});">
                                </div>
                            </div>
            ...
            <div class="sider-wrap">
                ...
                <div class="subfiled-content">
                    <ul class="welcome_list">
                        <li class="notice"><a href="###" title="最新废票公告【必看】" onclick="showNotice('44', 2, '最新废票公告【必看】')">最新废票公告【必看】</a>
                        </li>
                        <li class="notice"><a href="###" title="关于客票行程单打印通知"
                                              onclick="showNotice('42', 2, '关于客票行程单打印通知')">关于客票行程单打印通知</a></li>
                        <li class="notice"><a href="###" title="关于网银付款升级通知" onclick="showNotice('27', 2, '关于网银付款升级通知')">关于网银付款升级通知</a>
                        </li>
                        <li class="notice"><a href="###" title="代理人将无法直接修改所订乘机人的证件号码"
                                              onclick="showNotice('26', 2, '代理人将无法直接修改所订乘机人的证件号码')">代理人将无法直接修改所订乘...</a>
                        </li>
