    ...
    <div style="margin-left: 5%;margin-top: 5%">
        <div class="kv-item clearfix">
            ...
            <div class="kv-item-content" style="line-height:30px;">
                <input type="text" disabled="disabled" value="${id}" id="deptID">
            </div>
        </div>
        <div class="kv-item clearfix">
            <label>职位ID编号：</label>
        ...
        <div class="kv-item clearfix">
            <label>职位名称：</label>
            <div class="kv-item-content" style="line-height:30px;">
                <input type="text" placeholder="" id="jobName">
            </div>
        </div>
        <div class="kv-item clearfix">
            <label>职位介绍：</label>
            <div class="kv-item-content" style="line-height:30px;">
                <input type="text" placeholder="" id="jobText">
            </div>
        </div>

        <button class="sapar-btn sapar-btn-recom" value="" style="margin-left: 40%" onclick="modifyinfo()">确认添加</button>
    </div>
</div>
</body>
...
<script type="text/javascript">
    ...
    function modifyinfo() {
        ...
        $.post(
                '${pageContext.request.contextPath}/dept/addjob',
                {
                    deptID: deptID,
                    jobName: jobName,
                    jobID: jobID,
